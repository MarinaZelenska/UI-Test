...
public class compressionMonitors extends BaseUITestFile {
    ...
    public void positiveCompressionMonitorsTest() {
        ...
        WebElement icon2 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button//span[contains(text(), '2')]")));
        ...
        WebElement waitImagecomparePage = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='product__picture']")));
